const cryptoContainer = document.getElementById("bitcoin");
...
function loadBitcoinPrediction() {
  var xhr = new XMLHttpRequest();
  xhr.open('GET', 'data/btc_forecast');
  xhr.onload = function() {
    if (xhr.status === 200) {
...
function renderHTML(data) {
    ...
    var day30 = data[29]
    var day50 = data[49]
    price = [btc_latest, day1, day3, day7, day30, day50]

    htmlString += '<td><img src="../static/images/btc-logo.png" alt="BTC Logo" height="20px" width="20px">&nbsp;<a href="bitcoin.html">BTC (Bitcoin)</a></td>';
...
//window.onload = loadBitcoinPrediction;
