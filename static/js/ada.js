var cryptoContainer = document.getElementById("cardano");
...
function loadCardanoPrediction() {
  var xhr = new XMLHttpRequest();
  xhr.open('GET', 'data/ada_forecast');
  xhr.onload = function() {
    if (xhr.status === 200) {
...
function renderHTML(data) {
    ...
    var day30 = data[29]
    var day50 = data[49]
    price = [ada_latest, day1, day3, day7, day30, day50]

    htmlString += '<td><img src="../static/images/ada-logo.png" alt="ADA Logo" height="20px" width="20px">&nbsp;<a href="cardano.html">ADA (Cardano)</a></td>';
