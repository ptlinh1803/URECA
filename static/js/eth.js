var cryptoContainer = document.getElementById("ethereum");
...
function loadEthereumPrediction() {
  var xhr = new XMLHttpRequest();
  xhr.open('GET', 'data/eth_forecast');
  xhr.onload = function() {
    if (xhr.status === 200) {
...
function renderHTML(data) {
    ...
    var day30 = data[29]
    var day50 = data[49]
    price = [eth_latest, day1, day3, day7, day30, day50]

    htmlString += '<td><img src="../static/images/eth-logo.png" alt="ETH Logo" height="20px" width="20px">&nbsp;<a href="ethereum.html">ETH (Ethereum)</a></td>';
