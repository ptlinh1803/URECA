var cryptoContainer = document.getElementById("solana");
...
function loadSolanaPrediction() {
  var xhr = new XMLHttpRequest();
  xhr.open('GET', 'data/sol_forecast');
  xhr.onload = function() {
    if (xhr.status === 200) {
...
function renderHTML(data) {
    ...
    var day30 = data[29]
    var day50 = data[49]
    price = [sol_latest, day1, day3, day7, day30, day50]

    htmlString += '<td><img src="../static/images/sol-logo.png" alt="SOL Logo" height="20px" width="20px">&nbsp;<a href="solana.html">SOL (Solana)</a></td>';
