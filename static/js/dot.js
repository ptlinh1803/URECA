var cryptoContainer = document.getElementById("polkadot");
...
function loadPolkadotPrediction() {
  var xhr = new XMLHttpRequest();
  xhr.open('GET', 'data/dot_forecast');
  xhr.onload = function() {
    if (xhr.status === 200) {
...
function renderHTML(data) {
    ...
    var day30 = data[29]
    var day50 = data[49]
    price = [dot_latest, day1, day3, day7, day30, day50]

    htmlString += '<td><img src="../static/images/dot-logo.png" alt="DOT Logo" height="20px" width="20px">&nbsp;<a href="polkadot.html">DOT (Polkadot)</a></td>';
